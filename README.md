...
Third app in the finger-frame family:

| App | Generation | Latency |
|---|---|---|
| [finger-frame-effect](https://github.com/sophiamyang/finger-frame-effect) | local canvas effects | none |
| [finger-frame-effect-ai](https://github.com/sophiamyang/finger-frame-effect-ai) | Gemini Omni Flash (offline video edit) | minutes |
| **this app** | Decart Lucy 2.5 (realtime v2v) | ~real time |
